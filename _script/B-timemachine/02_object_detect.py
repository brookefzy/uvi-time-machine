"""This script uses yolov10 to further detect people, car, trucks etc"""
...
FOLDER_TO_SAVE = "{ROOTFOLDER}/_curated/{cityabbr}"
FILE_TO_SAVE = "{ROOTFOLDER}/_curated/{cityabbr}/n={part}_objects.parquet"
...
def main():
    ...
    args.add_argument("--city", type=str, default="New York")
