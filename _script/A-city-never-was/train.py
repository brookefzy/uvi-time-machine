...
train_df = pd.read_parquet(os.path.join(CURATED_FOLDER, "c_train.parquet"))[
    ["path", "label", "data_group", "city"]
]
test_df = pd.read_parquet(os.path.join(CURATED_FOLDER, "c_test.parquet"))[
    ["path", "label", "data_group", "city"]
]
...
for epoch in tqdm(range(EPOCHS)):
    ...
    if valid_loss < best_valid_loss:
        ...
        torch.save(model.module.state_dict(), f"./checkpoint/model-large-{epoch}.pt")
