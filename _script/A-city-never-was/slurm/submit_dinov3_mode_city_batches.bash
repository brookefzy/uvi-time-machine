#!/usr/bin/env bash
set -euo pipefail
BATCH_SIZE="${BATCH_SIZE:-20}"; ARRAY_CONCURRENCY="${ARRAY_CONCURRENCY:-2}"; FIRST_CITY="${FIRST_CITY:-0}"; LAST_CITY="${LAST_CITY:?Set LAST_CITY}"; JOB_SCRIPT="${JOB_SCRIPT:?Set JOB_SCRIPT}"
