...
class LRFinder:
    def __init__(self, model, optimizer, criterion, device):
        ...
        torch.save(model.module.state_dict(), "init_params.pt")
    ...
    def range_test(
        ...
        model.module.load_state_dict(torch.load("init_params.pt"))
...
train_df = pd.read_parquet(os.path.join(CURATED_FOLDER, "c_train_median.parquet"))[
    ["path", "label", "data_group", "city"]
]
test_df = pd.read_parquet(os.path.join(CURATED_FOLDER, "c_test_median.parquet"))[
    ["path", "label", "data_group", "city"]
]
...
FOUND_LR = 1e-3
params = [
    {"params": model.module.conv1.parameters(), "lr": FOUND_LR / 10},
    {"params": model.module.bn1.parameters(), "lr": FOUND_LR / 10},
    {"params": model.module.layer1.parameters(), "lr": FOUND_LR / 8},
    {"params": model.module.layer2.parameters(), "lr": FOUND_LR / 6},
    {"params": model.module.layer3.parameters(), "lr": FOUND_LR / 4},
    {"params": model.module.layer4.parameters(), "lr": FOUND_LR / 2},
...
def calculate_topk_accuracy(y_pred, y, k=10):
    with torch.no_grad():
...
for epoch in tqdm(range(EPOCHS)):
    ...
    if valid_loss < best_valid_loss:
        ...
        torch.save(model.module.state_dict(), f"./checkpoint/model-medium-{epoch}.pt")
